      ...
      >
        ...
        <div className="flex flex-col space-y-1">
          ...
          <div className="text-xs text-gray-500 font-medium">
            Questions: 08 | Duration: 15 mins | Submitted on 17 Nov 2024
          </div>
        </div>
        <button
      ...
      {isPopupOpen && (
        <div className="fixed inset-0 flex items-center justify-center z-20">
          <div className="bg-white p-8 rounded-lg shadow-lg  flex flex-col">
            ...
            <div className=" w-full border px-2 flex justify-between py-2">
            ...
            <div className=" w-full border px-2 flex justify-between  py-2">
                ...
                <div className="flex space-x-3 border-2 w-full items-center">
                    <div className="h-5 w-5 bg-blue-800 rounded-full tesxt-sm flex justify-center items-center text-white">1</div>
                    <div className="text-md ml-3 ">Update your <span className="font-bold">Rank</span></div>
                </div>
